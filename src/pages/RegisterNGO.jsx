...
const RegisterNGO = () => {
    ...
    return (
        ...
        >
            <Navbar background="bg-[#022c22]" variant="light" />
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select className="w-full h-12 pl-4 pr-10 bg-gray-50 border border-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all appearance-none cursor-pointer">
                                        <option>Select primary cause...</option>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors group">
                                    <UploadCloud className="mx-auto text-gray-400 group-hover:text-emerald-500 mb-2 transition-colors" size={24} />
                                    <p className="text-sm font-medium text-emerald-600">Click to upload <span className="text-gray-500 font-normal">or drag and drop</span></p>
