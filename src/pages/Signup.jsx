            ...
            <div className="relative z-10 w-full max-w-[440px] px-6">
                <div className="bg-white rounded-3xl p-8 shadow-2xl w-full">
                    ...
                    <div className="text-center mb-6">
                        <div className="inline-flex items-center gap-2 font-extrabold text-2xl text-gray-900 mb-4">
                    ...
                    {/* Divider */}
                    <div className="flex items-center my-4 text-gray-400 text-xs font-medium">
                    ...
                    <p className="text-center mt-4 text-sm text-gray-500">
                        ...
                        <Link to="/login" className="font-semibold text-gray-900 hover:text-emerald-600 transition-colors">
                            Log in
                        </Link>
                    </p>
                </div>
